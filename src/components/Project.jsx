    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8'>
      ...
      {data.map((project) => {
         return (
            ...
            <div key={project.id} className=" max-w-md mx-auto md:max-w-2xl min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-xl">
               ...
               <div className="flex flex-wrap justify-center">
                  ...
                  <div className="flex flex-wrap justify-center">
                     <div className="w-full px-4">
                        ...
                        <a href={project.url} className="flex justify-center font-semibold text-black hover:text-slate-400">
